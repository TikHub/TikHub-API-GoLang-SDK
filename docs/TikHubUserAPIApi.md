...
> ResponseModel CalculatePriceApiV1TikhubUserCalculatePriceGet_0(ctx, endpoint, optional)
...
> ResponseModel GetAllEndpointsInfoApiV1TikhubUserGetAllEndpointsInfoGet(ctx, )
